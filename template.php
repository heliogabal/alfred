...
function alfred_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
...
function alfred_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}

function alfred_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
function alfred_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
}

function alfred_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}

function alfred_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
function alfred_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
